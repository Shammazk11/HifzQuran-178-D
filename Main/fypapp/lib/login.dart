    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          _showCustomSnackBar('Logged in successfully!', icon: Icons.check_circle_outline);
          Future.delayed(const Duration(seconds: 2), () {
            if (mounted) Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const HomePage()));
          });
        } else {
          var responseData = jsonDecode(response.body);
          _showCustomSnackBar(responseData['message'] ?? 'Login failed', isError: true);
        }
      } catch (e) {
        setState(() => _isLoading = false);
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                onPressed: _isLoading ? null : () => AuthService().signInWithGoogle(context),
                              ...
                              TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()..onTap = () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SignupPage())),
                                  ),
                                ],
                              ),
                              textAlign: TextAlign.center,
                    ...
                    // Spacer to push content up and avoid excess whitespace
                    const Spacer(),
                  ],
                ),
              ),
